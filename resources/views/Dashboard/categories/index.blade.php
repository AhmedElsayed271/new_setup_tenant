                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                @if (auth('user')->user()->has_permission('update-Categories'))
                                                    <a class="dropdown-item"
                                                        href="{{ route('dashboard.categories.edit', $category->id) }}">{{ trans('admin.Edit') }}</a>
                                                @endif

                                                @if (auth('user')->user()->has_permission('delete-Categories'))
                                                    <a class="dropdown-item delete-popup" href="#" data-toggle="modal"
                                                        data-target="#modal-default"
                                                        data-url="{{ route('dashboard.categories.destroy', $category->id) }}">{{ trans('admin.Delete') }}</a>
                                                @endif
                                            </div>
                                        </div>
                                    </td>
